      ...
      <main className="flex-grow">
        <div className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4 font-serif">Amenities</h1>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-bold mb-6 font-serif">Building Features</h2>
              <div className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle className="font-serif">Building Features</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="font-serif">Resident Services</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2 text-gray-600">
                      <li className="flex items-start">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-6 font-serif">Gallery</h2>
              ...
              <div className="mt-8">
                <h3 className="text-xl font-semibold mb-4 font-serif">Why Choose MTV Condos?</h3>
